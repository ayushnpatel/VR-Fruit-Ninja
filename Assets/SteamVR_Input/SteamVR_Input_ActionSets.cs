...
namespace Valve.VR
{
    ...
    public partial class SteamVR_Actions
    {
        ...
        private static SteamVR_Input_ActionSet_fruitninja p_fruitninja;
        ...
        public static SteamVR_Input_ActionSet_fruitninja fruitninja
        {
            get
            {
                return SteamVR_Actions.p_fruitninja.GetCopy<SteamVR_Input_ActionSet_fruitninja>();
            }
        }
        ...
        private static void StartPreInitActionSets()
        {
            ...
            SteamVR_Actions.p_fruitninja = ((SteamVR_Input_ActionSet_fruitninja)(SteamVR_ActionSet.Create<SteamVR_Input_ActionSet_fruitninja>("/actions/fruitninja")));
            Valve.VR.SteamVR_Input.actionSets = new Valve.VR.SteamVR_ActionSet[] {
                    SteamVR_Actions._default,
                    SteamVR_Actions.platformer,
                    SteamVR_Actions.buggy,
                    SteamVR_Actions.mixedreality,
                    SteamVR_Actions.fruitninja};
        }
    }
}
